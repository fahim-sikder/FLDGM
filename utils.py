...
eval_col_name = ['yauc', 'sauc', 'dp', 'di', 'ynn', 'zs_mi', 'ys_mi', 'precsn_scr', 'rec_score', 'acc_scr', 'f1_scr']
...
def evaluate(Z_train, Z_test, S_train, S_test, Y_train, Y_test, cls_name='rf'):
    ...
    return np.array([yauc, sauc, dp, di, ynn, zs_mi, ys_mi, prs_scr, rec_scr, acc_scr, f1_scr])